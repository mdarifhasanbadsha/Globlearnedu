...
export const programsData: Record<string, ProgramData> = {
  ...
  "bachelors-degree": {
    ...
    relatedSlugs: ["masters-degree", "chinese-language", "mba-business"],
  },
  ...
  "masters-degree": {
    ...
    relatedSlugs: ["phd-program", "bachelors-degree", "mba-business"],
  },
  ...
  "phd-program": {
    ...
    relatedSlugs: ["masters-degree", "artificial-intelligence", "bachelors-degree"],
  },
  ...
  "mba-business": {
    slug: "mba-business",
    name: "MBA & Business",
    tagline: "Lead in China's economy — MBA programs built for global markets.",
    category: "Business",
    duration: "1.5–2 years",
    tuitionRange: "¥30,000 – ¥80,000 / year",
    livingCost: "¥2,000 – ¥4,000 / month",
    language: "English-taught (most programs)",
    intakeMonths: "September 2026 / January 2027",
    icon: "Briefcase",
    color: "#1B3A6B",
    heroImage: "/images/programs/mba.jpg",
    overview:
      "Chinese MBA programs blend Western business education with deep insights into the world's second-largest economy. Programs at top Chinese business schools are ranked globally and attract executives and entrepreneurs from 50+ countries. With China's expanding role in African and Middle Eastern trade, an MBA from China is a strategic career investment.",
    highlights: [
      { icon: "Clock", title: "Duration", value: "1.5–2 Years" },
      { icon: "DollarSign", title: "Annual Tuition", value: "¥30,000 – ¥80,000" },
      { icon: "Globe", title: "Medium", value: "English (most programs)" },
      { icon: "Award", title: "Network", value: "Global Alumni Network" },
    ],
    universities: [
      { name: "CEIBS (China Europe Business School)", city: "Shanghai", tuitionRMB: "¥498,000 total", scholarshipAvailable: true, ranking: "FT Top 10 Asia" },
      { name: "Peking University Guanghua", city: "Beijing", tuitionRMB: "¥128,000", scholarshipAvailable: true, ranking: "Top 5 China" },
      { name: "Fudan University School of Management", city: "Shanghai", tuitionRMB: "¥98,000", scholarshipAvailable: true },
      { name: "Tongji University", city: "Shanghai", tuitionRMB: "¥60,000", scholarshipAvailable: true },
      { name: "University of International Business", city: "Beijing", tuitionRMB: "¥45,000", scholarshipAvailable: true },
      { name: "Shandong University MBA", city: "Jinan", tuitionRMB: "¥30,000", scholarshipAvailable: false },
    ],
    requirements: [
      "Bachelor's degree in any discipline",
      "Minimum 2–3 years of work experience (some programs require 5+)",
      "GMAT 550+ or GRE equivalent (top schools)",
      "English proficiency (IELTS 6.5+ or TOEFL 90+)",
      "Statement of purpose / essays",
      "Two professional references",
    ],
    careerProspects: [
      "Senior management and C-suite roles",
      "China-Africa / China-ME trade and investment",
    ...
    scholarships: [
      "CSC scholarship (select programs)",
      "Business school merit scholarships",
      "China-Africa Business Council scholarships",
      "Self-sponsored — significant ROI on career advancement",
    ],
    faqs: [
      {
        q: "Do I need work experience for a Chinese MBA?",
        a: "Most MBA programs require 2–3 years of professional experience. CEIBS and Guanghua require 5+ years. Some programs (e.g. MBA in Shandong) accept fresh graduates.",
      },
      {
        q: "Is a Chinese MBA recognised internationally?",
        a: "Top Chinese business schools are FT, QS, and AACSB accredited. CEIBS is consistently ranked in the FT Top 10 globally. Degrees from these schools are fully recognised internationally.",
      },
      {
        q: "Can I network with Chinese business leaders during my MBA?",
        a: "Yes. Guest speakers, company visits, and alumni networks give direct access to executives from Chinese Fortune 500 companies and multinational firms operating in China.",
      },
      {
        q: "What language is the MBA taught in?",
        a: "Most international MBA programs in China are fully English-medium. Some programs include elective modules in Chinese. No Chinese proficiency is required for English-taught MBAs.",
      },
    ],
    relatedSlugs: ["masters-degree", "bachelors-degree", "artificial-intelligence"],
  },

  "artificial-intelligence": {
    slug: "artificial-intelligence",
    name: "Artificial Intelligence",
    tagline: "Study AI in the country leading the world's tech revolution.",
    category: "Technology",
    duration: "3–4 years (Bachelor's) / 2–3 years (Master's)",
    tuitionRange: "¥20,000 – ¥45,000 / year",
    ...
    icon: "Brain",
    color: "#29ABE2",
    heroImage: "/images/programs/ai.jpg",
    overview:
      "China is the world's largest investor in artificial intelligence, with Baidu, Alibaba, Tencent, and Huawei all headquartered here. AI programs at Chinese universities blend cutting-edge theory with real industry partnerships. Students gain hands-on experience with machine learning, computer vision, NLP, and robotics — skills valued worldwide in a rapidly growing field.",
    highlights: [
      { icon: "Clock", title: "Duration", value: "2–4 Years" },
      { icon: "DollarSign", title: "Annual Tuition", value: "¥20,000 – ¥45,000" },
      { icon: "Globe", title: "Industry", value: "Baidu · Alibaba · Huawei" },
      { icon: "Award", title: "Growth", value: "Fastest Growing Field" },
    ],
    universities: [
      { name: "Tsinghua University", city: "Beijing", tuitionRMB: "¥40,000", scholarshipAvailable: true, ranking: "QS Top 25" },
      { name: "Peking University", city: "Beijing", tuitionRMB: "¥38,000", scholarshipAvailable: true, ranking: "QS Top 15" },
      { name: "Shanghai Jiao Tong University", city: "Shanghai", tuitionRMB: "¥35,000", scholarshipAvailable: true, ranking: "QS Top 50" },
      { name: "Zhejiang University", city: "Hangzhou", tuitionRMB: "¥28,000", scholarshipAvailable: true, ranking: "985 University" },
      { name: "University of Electronic Science", city: "Chengdu", tuitionRMB: "¥22,000", scholarshipAvailable: true },
      { name: "Beijing University of Posts", city: "Beijing", tuitionRMB: "¥20,000", scholarshipAvailable: false },
    ],
    requirements: [
      "Strong background in Mathematics and Computer Science",
      "High school diploma (Bachelor's) or Bachelor's in CS/Engineering (Master's)",
      "English proficiency (IELTS 6.0+)",
      "Programming portfolio or projects preferred",
      "Research proposal for Master's/PhD applicants",
      "Academic transcripts with math/science grades highlighted",
    ],
    careerProspects: [
      "AI/ML engineer at tech companies globally",
      "Data scientist and analytics lead",
      "Computer vision and NLP researcher",
      "Robotics and automation engineer",
      "AI product manager and entrepreneur",
      "Academic researcher and professor",
    ],
    scholarships: [
      "CSC (Chinese Government Scholarship) — full tuition + stipend",
      "University AI excellence scholarships",
      "Industry-sponsored scholarships (Baidu, Huawei)",
      "Provincial tech innovation scholarships",
    ],
    faqs: [
      {
        q: "Is China really a global leader in AI?",
        a: "Yes. China files more AI patents than any other country and has more AI startups than the USA. Tsinghua and Peking University AI departments are globally top-ranked. The ecosystem for applied AI research is unmatched.",
      },
      {
        q: "Do I need to know Python or programming to apply?",
        a: "For Bachelor's programs, no prior programming is required. For Master's and PhD, strong Python skills and familiarity with ML frameworks (TensorFlow, PyTorch) are expected.",
      },
      {
        q: "Can international AI graduates work in China after graduation?",
        a: "Yes, with a work visa. Many international graduates join Chinese tech firms or startups. Others return home with skills highly valued by local tech companies.",
      },
      {
        q: "Are there English-medium AI programs?",
        a: "Yes. 985 universities like Tsinghua, PKU, and SJTU have English-medium AI and CS programs. Research groups in these universities often work entirely in English.",
      },
    ],
    relatedSlugs: ["masters-degree", "phd-program", "mba-business"],
  },
};
