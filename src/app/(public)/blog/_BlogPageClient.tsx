...
function catColor(category: string) {
  return CATEGORY_COLORS[category] ?? "#1B3A6B";
}
    ...
    <>
      ...
      <section className="py-14 px-4 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <p className="text-xs font-bold tracking-widest uppercase text-[#C8102E] mb-6">Featured Article</p>
          <Link
          ...
          >
            <div className="h-2 w-full" style={{ backgroundColor: catColor(featured.category) }} />
            <div className="p-8 md:p-10">
              <div className="flex flex-wrap items-center gap-3 mb-5">
                <span className="text-xs font-bold px-3 py-1 rounded-full text-white" style={{ backgroundColor: catColor(featured.category) }}>
                  {featured.category}
                </span>
              ...
              <p className="text-gray-500 text-base leading-relaxed mb-6 max-w-3xl">{featured.excerpt}</p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map(post => (
              ...
              >
                <div className="h-1.5 w-full flex-shrink-0" style={{ backgroundColor: catColor(post.category) }} />
                <div className="p-5 flex flex-col flex-1">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-xs font-semibold px-2.5 py-0.5 rounded-full text-white" style={{ backgroundColor: catColor(post.category) }}>
                      {post.category}
                    </span>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-xs font-bold tracking-widest uppercase text-[#C8102E] mb-4">Topics We Cover</p>
          <div className="flex flex-wrap justify-center gap-2">
            {[
              ...
              <span key={tag} className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full bg-gray-100 text-gray-600 text-xs font-medium">
                <Tag size={11} />{tag}
              </span>
            ))}
          </div>
