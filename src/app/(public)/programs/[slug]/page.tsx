...
export default async function ProgramPage({
  ...
  return (
    <>
      ...
      {/* Requirements + Career side by side */}
      <section className="py-14 px-4 bg-white">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <p className="mt-6 text-xs text-gray-400">
              Not sure if you qualify? Send us your documents — we assess for free.
            </p>
          </div>
              ...
              {related.map((rel) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="text-xs font-semibold text-gray-400 group-hover:text-white/50">
                      {rel.category}
                    </span>
                  </div>
                  <h3 className="font-bold text-[#1B3A6B] group-hover:text-white mb-1">
                    {rel.name}
                  </h3>
                  <p className="text-xs text-gray-500 group-hover:text-white/60">
                    {rel.duration}
                  </p>
                </Link>
              ))}
