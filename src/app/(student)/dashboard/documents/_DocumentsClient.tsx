...
type DocStatus = "uploaded" | "under_review" | "approved" | "rejected" | "missing";
...
export default function DocumentsClient({ initialDocs }: { initialDocs: Doc[] }) {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm" style={{ color: "#64748B" }}>Upload and manage your application documents.</p>
      </div>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap mb-1">
                  <p className="text-sm font-bold leading-snug" style={{ color: "#1B3A6B" }}>{doc.name}</p>
                  <span
                ...
                {doc.fileName && (
                  <p className="text-xs font-medium" style={{ color: "#64748B" }}>{doc.fileName}</p>
                )}
              ...
              <label className="flex-shrink-0 cursor-pointer">
                ...
                <span
                  ...
                  style={{ borderColor: "#E2E8F0", backgroundColor: "white", color: "#475569" }}
                >
                  <Upload size={12} />
      ...
      <div className="mt-6 border-2 border-dashed rounded-2xl p-6 text-center" style={{ borderColor: "#E2E8F0" }}>
        ...
        <p className="text-sm font-semibold mb-1" style={{ color: "#1B3A6B" }}>Upload additional document</p>
