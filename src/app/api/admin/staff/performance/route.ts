...
export async function GET(req: NextRequest) {
  ...
  // Application stats per assigned staff
  ...
  // Notes count per staff (counts all internal note entries on their applications)
  ...
  // Team totals
  const team = members.reduce((acc, m) => ({
