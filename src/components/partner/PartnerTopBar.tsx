...
export default function PartnerTopBar({ userName, userInitials }: Props) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <Link href="/partner" className="md:hidden flex items-center gap-2">
          ...
          <span className="text-sm font-bold" style={{ color: "#1B3A6B" }}>Partner Portal</span>
        </Link>
        <span className="hidden md:block text-sm font-semibold" style={{ color: "#1B3A6B" }}>Partner Portal</span>
      </div>

      <div className="flex items-center gap-3">
        <Link href="/partner/notices" className="relative flex items-center justify-center w-9 h-9 rounded-lg hover:bg-gray-50">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            <div className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold text-white flex-shrink-0" style={{ backgroundColor: "#C8102E" }}>
          ...
          {dropdownOpen && (
            <div className="absolute right-0 top-full mt-1 w-44 rounded-xl border shadow-lg py-1 z-50" style={{ backgroundColor: "white", borderColor: "#E2E8F0" }}>
              <Link href="/partner/profile" onClick={() => setDropdownOpen(false)}
