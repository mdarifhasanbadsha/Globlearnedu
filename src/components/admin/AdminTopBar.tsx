    ...
    >
      <div className="flex items-center gap-3">
        <Link href="/admin" className="md:hidden flex items-center gap-2">
          ...
          <span className="text-sm font-bold" style={{ color: "#0A1628" }}>Admin</span>
        </Link>
        <div className="hidden md:flex items-center gap-2">
          <Shield size={15} style={{ color: "#29ABE2" }} />
          <span className="text-sm font-semibold" style={{ color: "#0A1628" }}>Admin Panel</span>
          <span className="text-[10px] font-bold px-2 py-0.5 rounded-full" style={{ backgroundColor: "#EFF6FF", color: "#1E40AF" }}>
            Globlearn Education
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        <button className="relative flex items-center justify-center w-9 h-9 rounded-lg hover:bg-gray-50">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            <div className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold text-white flex-shrink-0" style={{ backgroundColor: "#7C3AED" }}>
          ...
          {dropdownOpen && (
            <div className="absolute right-0 top-full mt-1 w-48 rounded-xl border shadow-lg py-1 z-50" style={{ backgroundColor: "white", borderColor: "#E2E8F0" }}>
              <div className="px-4 py-2.5" style={{ borderBottom: "1px solid #F1F5F9" }}>
                <p className="text-[10px] font-bold uppercase tracking-widest" style={{ color: "#7C3AED" }}>Admin</p>
